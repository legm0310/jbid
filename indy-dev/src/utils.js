...
async function mkdir(filePath) {
  return new Promise((resolve, reject) => {
      ...
      mkdirp(folderPath, { recursive: true }, function (err, res) {
          if (err) reject(err);
          else resolve(res);
      })
  }) 
...
module.exports = {
  ...
  poolGenesisTxnData,
  pathToIndyClientHome,
  savePoolGenesisTxnFile,
  POOL_NAME,
  PROTOCOL_VERSION,
};
